...
@endif
                <div class="general-info col-sm-10  col-sm-offset-1">
                    ...
                    <section class="row">
                                   <!-- Form -->
                {!! Form::model($becario,['class'=>'form-group col-lg-12','method' => 'PATCH','files' => 'true','action'=>['AdministradorController@edit_n']]) !!}
               ...
               {!! Form::close() !!}
                    ...
                    <section class="row">
                        {!! Form::model($becario,['class'=>'form-group col-lg-12','method' => 'PATCH','action'=>['AdministradorController@edit_p']]) !!}
                            <h4>Contraseña</h4>
                            <div class="between-form form-group">
                                {!! Form::hidden('usuario',$becario->user->id) !!}
               ...
               <!-- Form -->
                {!! Form::model($emergencia,['class'=>'form-group col-lg-12','method' => 'PATCH','action'=>['AdministradorController@edit_e']]) !!}
               ...
               {!! Form::close() !!}
                ...
                {!! Form::model($academica,['class'=>'form-group col-lg-12','method' => 'PATCH','action'=>['AdministradorController@edit_a']]) !!}
               ...
               {!! Form::close() !!}
                ...
                {!! Form::model($habilidad,['class'=>'form-group col-lg-12','method' => 'PATCH','action'=>['AdministradorController@edit_h']]) !!}
                <h5>Habilidades:</h5>
