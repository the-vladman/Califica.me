...
<head>
    ...
    <link rel="shortcut icon" href="/front/img/icon.png">
...
<body class="container">
        ...
        <div class="page-wrapper-login">
            @if (count($errors) > 0)
                ...
                <!-- Page Heading -->
            <form class=" form-login text-center col-lg-6 col-sm-6" method="POST" action="{{ url('/login') }}">
                ...
                <div class="form-group text-center ">
                  ...
                  <a href="{{ url('/olvide') }}">¿Olvidaste tu contraseña?</a>
            </form>
